...
#         # --- 수정된 부분: 경로와 차량 소환 ---
#         # 마지막에 출발지(121)를 추가하여 루프 경로 생성
#         route_indices = [121, 11, 85, 93, 57, 43, 118, 79, 104, 95, 121]
...
#         # hardcoded route_indices를 사용하여 경로 생성
#         route = []
...
def main():
    ...
    try:
        ...
        #경로
        route_indices_0 = [121, 11, 85, 93, 57, 43, 118, 79, 104, 95]
        route_indices = [121, 11, 85, 91, 111, 141]
